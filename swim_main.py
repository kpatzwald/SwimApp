...
class app(tk.Frame) :
	...
	def create_widgets(self):
		...
		ttk.Label(self.frm, text="Entfernung: ", padding=5).grid(column=0, row=2)
		ttk.Label(self.frm, text="Entfernung Kraul: ", padding=5).grid(column=0, row=3)
		ttk.Label(self.frm, text="Entfernung Brust: ", padding=5).grid(column=0, row=4)
		ttk.Label(self.frm, text="Dauer: ", padding=5).grid(column=0, row=5)
		...
		ttk.Button(self.frm, text="Eintrag anlegen", command=self.button_new_entry_pressed).grid(column=1, row=6)
